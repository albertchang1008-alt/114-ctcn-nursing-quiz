...
window.FIREBASE_V18_CONFIG = {
  enabled: true,
  allowLegacyQuestionFallback: false,
  firebaseConfig: {
  ...
  collections: {
    questions: "questions",
    questionBundle: "questionBundles/current",
    publicConfig: "publicConfig/main",
    questionBankRoot: "questionBanks",
    questionChapterRoot: "questionChapterBundles",
    students: "students",
